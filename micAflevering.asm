...
Bseg:
			LDI		R18, segB			;læs værdien af segB ind i R18
			OUT		PORTB, R18			;skriv værdien af R18 til PORTB (dispalyet)
			IN 		R17, PINC			;læs værdien af port c ind i R17
			LDI		R20, 0x97			;læs værdien 0x97 ind 9 R20
...
Cseg:
			LDI		R18, segC			;læs værdien af segC ind i R18
			OUT		PORTB, R18			;skriv værdien af R18 til PORTB (dispalyet)
			IN 		R17, PINC			;læs værdien af port c ind i R17
			LDI		R20, 0x97			;læs værdien 0x97 ind 9 R20
...
Dseg:
			LDI		R18, segD			;læs værdien af segD ind i R18
			OUT		PORTB, R18			;skriv værdien af R18 til PORTB (dispalyet)
			IN 		R17, PINC			;læs værdien af port c ind i R17
			LDI		R20, 0x97			;læs værdien 0x97 ind 9 R20
...
Eseg:
			LDI		R18, segE			;læs værdien af segE ind i R18
			OUT		PORTB, R18			;skriv værdien af R18 til PORTB (dispalyet)
			IN 		R17, PINC			;læs værdien af port c ind i R17
			LDI		R20, 0x97			;læs værdien 0x97 ind 9 R20
...
Fseg:
			LDI		R18, segF			;læs værdien af segF ind i R18
			OUT		PORTB, R18			;skriv værdien af R18 til PORTB (dispalyet)
			IN 		R17, PINC			;læs værdien af port c ind i R17
			LDI		R20, 0x97			;læs værdien 0x97 ind 9 R20
